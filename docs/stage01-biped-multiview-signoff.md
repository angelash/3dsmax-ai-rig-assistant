...
- Leg clothing occlusion: if robe, skirt, cape or boot volume hides the real legs, hip/knee/ankle must be judged from under-clothing anatomy plus visible foot pivots, not from the garment outline.
