...
def write_out_readme(root: Path) -> None:
    ...
    lines += [
        ...
        "",
        "这里会放 `full/` 全局证据图、`regions/` 局部裁剪、`semantic_analysis/` 贴图语义叠加、`slices/` MR 式切片、`review_input.md`、`review_schema.json` 和 `semantic_visual_review_template.json`。它用于人工或 VLM 按固定 blocker 审查，不产生分数。",
        "",
