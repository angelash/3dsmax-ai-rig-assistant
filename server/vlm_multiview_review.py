...
def build_prompt(asset_name: str, review_input: str, schema: dict[str, Any]) -> str:
    return "\n".join(
        [
            ...
            "- For legs hidden by robe/skirt/cape/boots, treat clothing-outline following as a blocker; judge hip/knee/ankle from under-clothing anatomy and visible foot pivots.",
